...
var KFC200 = {
    new : func(prop1){
        ...
        m.alt=props.globals.initNode("autopilot/settings/target-altitude-ft",10000,"DOUBLE");
        m.dhalert=m.kfc200.initNode("dh-alert",0,"BOOL");
        m.DH=m.kfc200.initNode("DH",200,"DOUBLE");
        m.asel=m.kfc200.initNode("alt-preset",10000,"DOUBLE");
...
### Decision Hold check ###
    dh_check : func{
        var tst =0;
        var myalt=getprop("position/altitude-agl-ft");
